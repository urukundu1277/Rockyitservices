                  ...
                  <table className="w-full text-left min-w-[720px] rounded-lg overflow-hidden">
                    <thead className="bg-gradient-to-r from-gray-100 to-white">
                      <tr className="text-sm text-gray-600">
                        ...
                        <th className="p-4">Service / Issue</th>
                    ...
                    <tbody>
                      {filtered.map((customer) => (
                        <tr key={customer._id} className="border-b hover:bg-gray-50 transition">
                          ...
                          <td className="p-4">{new Date(customer.createdAt).toLocaleString()}</td>
                          <td className="p-4">
                            <div className="flex items-center gap-3">
                          ...
                          <td className="p-4">
                            <div className="flex items-center gap-2">
                              <button onClick={() => openWhatsApp(customer.whatsappNumber, customer)} className="flex items-center gap-2 px-3 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg transition">
